This project investigates open star clusters using astrometric data from the **Gaia mission**. It applies advanced clustering techniques to identify and characterize stellar groupings in the Milky Way.
